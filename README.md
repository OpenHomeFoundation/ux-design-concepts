...
Design concepts for the Open Home Foundation. Only the `public/` folder is deployed (as a Cloudflare static-assets Worker), each concept lives in its own folder inside it. Nothing here is production software.
