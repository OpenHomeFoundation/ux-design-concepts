// device.jsx — Home Assistant "device" config page for the AUX-2 (Nabu Casa Connect Proxy).
    ...
    <div className="ha-app">
      ...
      <div className="main">
        <header className="appbar">
          ...
          <h1 className="appbar__title">AUX-2</h1>
        ...
        <div className="content">
          <div className="content-inner">
            ...
            <ProxyBanner statuses={statuses} deviceName="AUX-2" onOpen={() => setOpen(true)}></ProxyBanner>
