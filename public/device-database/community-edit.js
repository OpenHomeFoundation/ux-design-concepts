/* AUTO-GENERATED build artifact — compiled from community-edit.jsx.
   Do not edit this file by hand. Edit community-edit.jsx and rebuild. */
...
function useIncrement(key) {
  ...
  const [on, setOn] = React.useState(() => document.documentElement.getAttribute(attr) === 'on');
  React.useEffect(() => {
...
if (typeof window !== 'undefined' && window.USERS) {
  ...
  Object.keys(stored).forEach(id => {
    if (!window.USERS[id]) window.USERS[id] = stored[id];
  });
}
...
function providerIdentity(method, fields) {
  ...
  if (method === 'github') {
    return {
      name: 'Sam Rivera',
      gh: 'samriv',
      email: 'samriv@users.noreply.github.com'
    };
  }
  if (method === 'email') {
    return {
...
function needsOnboarding(user) {
  return !!(user && user.__needsOnboarding);
}
...
function contributorDisplay(handleOrId) {
  ...
  const profilesOn = typeof document !== 'undefined' && document.documentElement.getAttribute('data-inc-contributor-profiles') === 'on';
  return {
...
function Avatar({
  ...
  if (!user) {
    return /*#__PURE__*/React.createElement("span", _extends({
      className: "ce-avatar ce-avatar-empty",
      style: {
        width: size,
        height: size
      },
...
function PhotoPlaceholder({
  ...
  const tints = [{
    from: 'var(--surface-tint-soft)',
    to: 'var(--surface-tint-mid)'
  }, {
    from: 'var(--surface-tint-mid)',
    to: 'var(--surface-tint-strong)'
  }, {
    from: 'var(--surface-tint-soft)',
    to: 'var(--surface-tint-strong)'
  }];
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "ce-photo-placeholder",
    role: "img",
    "aria-label": alt || 'Device photo'
  ...
  }, Glyph ? /*#__PURE__*/React.createElement("g", {
...
function PhotoGallery({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement(GalleryPhoto, {
    device: device,
    src: photos[active],
    index: active,
    draggable: false
  }), /*#__PURE__*/React.createElement("span", {
    className: "ce-gallery-zoom-hint",
    "aria-hidden": "true"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "plus",
    size: 16
  }))), photos.length > 1 ? /*#__PURE__*/React.createElement("div", {
    className: "ce-gallery-thumbs",
    role: "tablist",
    "aria-label": "Device photos"
    ...
    src: src,
    index: i
  })))) : null, lightbox ? /*#__PURE__*/React.createElement(Lightbox, {
    device: device,
    photos: photos,
    index: active,
    setIndex: setActive,
...
function Lightbox({
  ...
  const reset = React.useCallback(() => setView({
    s: 1,
    x: 0,
    y: 0
  }), []);
  ...
  const endPointer = e => {
    ...
    if (pointers.current.size === 0) gesture.current = null;else if (pointers.current.size === 1) {
  ...
  return ReactDOM.createPortal(/*#__PURE__*/React.createElement("div", {
    ...
    className: "ce-lb-count",
    "aria-live": "polite"
  }, index + 1, " / ", total) : /*#__PURE__*/React.createElement("span", null), /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "ce-lb-icon ce-lb-close",
    onClick: onClose,
    "aria-label": "Close"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "x",
    ...
    type: "button",
    className: "ce-lb-nav ce-lb-prev",
    onClick: () => go(-1),
    ...
    type: "button",
    className: "ce-lb-nav ce-lb-next",
    onClick: () => go(1),
    ...
    className: "ce-lb-zoom",
    role: "group",
    "aria-label": "Zoom controls"
  }, /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "ce-lb-icon",
    onClick: () => zoomBy(1 / 1.4),
    disabled: view.s <= LB_MIN + 0.001,
    "aria-label": "Zoom out"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "minus",
    size: 18
...
function EditAttribution({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "ce-attribution"
  }, /*#__PURE__*/React.createElement(Avatar, _extends({
    user: who.user,
    anon: who.hidden,
    size: 20
  }, hp)), /*#__PURE__*/React.createElement("span", {
    className: "ce-attribution-text"
  }, "Last edited", ' ', /*#__PURE__*/React.createElement("span", {
    className: "ce-attribution-when",
    title: formatDateTime(last.at)
  }, formatDateShort(last.at)), ' ', "by ", who.href ? /*#__PURE__*/React.createElement("a", _extends({
    className: "ce-byline-link",
    href: who.href
  }, hp), who.name) : /*#__PURE__*/React.createElement("span", {
    className: "ce-byline-private"
  }, who.name)), /*#__PURE__*/React.createElement("button", {
    type: "button",
...
function EditHistoryPanel({
  ...
  return /*#__PURE__*/React.createElement("section", {
    className: "detail-section ce-history-section",
    "aria-labelledby": "ce-history-head"
  }, /*#__PURE__*/React.createElement("div", {
    className: "ce-history-head"
  }, /*#__PURE__*/React.createElement("h2", {
    id: "ce-history-head"
  }, "Edit history"), /*#__PURE__*/React.createElement("span", {
    className: "ce-history-count"
  }, history.length, " edit", history.length === 1 ? '' : 's')), /*#__PURE__*/React.createElement("ol", {
    className: "ce-history-list"
  }, /*#__PURE__*/React.createElement(EditEntry, {
    entry: first
  }), open ? rest.map((e, i) => /*#__PURE__*/React.createElement(EditEntry, {
    key: i,
    entry: e
  })) : null), rest.length > 0 ? /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "ce-history-toggle",
    onClick: () => setOpen(o => !o)
  }, open ? /*#__PURE__*/React.createElement(React.Fragment, null, "Hide earlier edits") : /*#__PURE__*/React.createElement(React.Fragment, null, "Show ", rest.length, " earlier edit", rest.length === 1 ? '' : 's')) : null);
}
function EditEntry({
  entry
}) {
  ...
  return /*#__PURE__*/React.createElement("li", {
    className: "ce-history-entry"
  }, /*#__PURE__*/React.createElement("div", {
    className: "ce-history-byline"
  }, /*#__PURE__*/React.createElement(Avatar, _extends({
    user: who.user,
    anon: who.hidden,
    size: 24
  }, hp)), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    className: "ce-history-when"
  }, who.href ? /*#__PURE__*/React.createElement("a", _extends({
    className: "ce-byline-link ce-byline-strong",
    href: who.href
  }, hp), who.name) : /*#__PURE__*/React.createElement("span", {
    className: "ce-byline-strong ce-byline-private"
  }, who.name), /*#__PURE__*/React.createElement("span", {
    className: "ce-history-sep"
  }, "\xB7"), /*#__PURE__*/React.createElement("time", {
    dateTime: entry.at,
    title: formatDateTime(entry.at)
  }, formatDateTime(entry.at)), entry.pending ? /*#__PURE__*/React.createElement("span", {
    className: "ce-history-pending"
  }, /*#__PURE__*/React.createElement("span", {
    className: "ce-pending-dot",
    "aria-hidden": "true"
  }), " Awaiting review") : null), entry.summary ? /*#__PURE__*/React.createElement("div", {
    className: "ce-history-summary"
  }, entry.summary) : null)), entry.changes && entry.changes.length > 0 ? /*#__PURE__*/React.createElement("ul", {
    className: "ce-change-list"
  }, entry.changes.map((c, i) => /*#__PURE__*/React.createElement(EditChangeLine, {
    key: i,
    change: c
  }))) : null);
}
...
function SidebarEditHistory({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "aside-edits"
  }, /*#__PURE__*/React.createElement("div", {
    className: "aside-edits-head"
  }, /*#__PURE__*/React.createElement("h4", null, "Edit history")), pCount > 0 ? /*#__PURE__*/React.createElement("div", {
    className: "aside-edits-pending"
  }, /*#__PURE__*/React.createElement("span", {
    className: "ce-pending-dot",
    "aria-hidden": "true"
  }), /*#__PURE__*/React.createElement("span", null, pCount, " edit", pCount === 1 ? '' : 's', " awaiting review")) : null, total === 0 ? /*#__PURE__*/React.createElement("p", {
    className: "aside-edits-empty"
  }, "No edits yet.") : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("ol", {
    className: "aside-edit-list"
  }, /*#__PURE__*/React.createElement("li", {
    className: "aside-edit-row"
  }, /*#__PURE__*/React.createElement(Avatar, _extends({
    user: who.user,
    anon: who.hidden,
    size: 20
  }, hp)), /*#__PURE__*/React.createElement("div", {
    className: "aside-edit-body"
  }, /*#__PURE__*/React.createElement("div", {
    className: "aside-edit-line"
  }, who.href ? /*#__PURE__*/React.createElement("a", _extends({
    className: "aside-edit-name ce-byline-link",
    href: who.href
  }, hp), who.name) : /*#__PURE__*/React.createElement("span", {
    className: "aside-edit-name ce-byline-private"
  }, who.name), /*#__PURE__*/React.createElement("span", {
    className: "aside-edit-dot"
  }, "\xB7"), /*#__PURE__*/React.createElement("time", {
    dateTime: digest.at,
    title: formatDateTime(digest.at)
  }, formatDateShort(digest.at)), digest.pending ? /*#__PURE__*/React.createElement("span", {
    className: "aside-edit-pending-tag"
  }, /*#__PURE__*/React.createElement("span", {
    className: "ce-pending-dot",
    "aria-hidden": "true"
  }), " Awaiting review") : null), digest.summary ? /*#__PURE__*/React.createElement("div", {
    className: "aside-edit-summary"
  }, digest.summary) : null))), /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "aside-edit-viewall",
    onClick: () => setOpen(true)
  }, "View all ", total, " edit", total === 1 ? '' : 's')), open ? /*#__PURE__*/React.createElement(EditHistoryDialog, {
    device: device,
...
function EditHistoryDialog({
  ...
  const content = /*#__PURE__*/React.createElement("ol", {
    className: "ce-history-list"
  }, merged.map((e, i) => /*#__PURE__*/React.createElement(EditEntry, {
    key: i,
    entry: e
  })));
  if (isSheet) {
    ...
    }, "Edit history"))), /*#__PURE__*/React.createElement("div", {
  ...
  return ReactDOM.createPortal(/*#__PURE__*/React.createElement("div", {
    ...
    name: "x",
    size: 18
  })), /*#__PURE__*/React.createElement("h2", null, "Edit history"))), /*#__PURE__*/React.createElement("div", {
