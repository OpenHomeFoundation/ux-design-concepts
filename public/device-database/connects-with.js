/* AUTO-GENERATED build artifact — compiled from connects-with.jsx.
   Do not edit this file by hand. Edit connects-with.jsx and rebuild. */
...
function CwTabScroller({
  ...
  React.useEffect(() => {
    ...
    const update = () => {
      ...
      setEdge(p => p.start === start && p.end === end ? p : {
        start,
        end
      });
    };
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: 'cw-tabs-wrap' + (edge.start ? ' is-start' : '') + (edge.end ? ' is-end' : '')
...
function ConnectsWithAuto({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, hasMeta && /*#__PURE__*/React.createElement("dl", {
    className: "cw-meta"
  }, a.integrationName && /*#__PURE__*/React.createElement("div", {
    className: "cw-meta-row"
  }, /*#__PURE__*/React.createElement("dt", null, "Integration"), /*#__PURE__*/React.createElement("dd", null, a.integrationName, hint || null)), a.entities && a.entities.length > 0 && /*#__PURE__*/React.createElement("div", {
    className: "cw-meta-row"
  }, /*#__PURE__*/React.createElement("dt", null, "Supported entities"), /*#__PURE__*/React.createElement("dd", null, /*#__PURE__*/React.createElement("span", {
    className: "cw-entities"
  }, a.entities.map(et => /*#__PURE__*/React.createElement("span", {
    key: et,
    className: "mono"
  }, et))), hint || null))), a.docsLink && /*#__PURE__*/React.createElement("div", {
    className: "cw-doclink-ctas",
    "data-comment-anchor": "892bfad252-p-102-19"
  }, /*#__PURE__*/React.createElement("p", {
    className: "cw-doclink-cta"
  }, /*#__PURE__*/React.createElement("a", {
    href: a.docsLink.href,
    target: "_blank",
    rel: "noopener noreferrer"
  }, 'Read the ' + a.docsLink.label, " ", /*#__PURE__*/React.createElement(Icon, {
    name: "open",
    size: 12
  })))));
}
...
function ConnectsWithPanel({
  ...
  }, showContributor !== false && /*#__PURE__*/React.createElement(React.Fragment, null, hasSetup && /*#__PURE__*/React.createElement("div", {
    className: "cw-section"
  }, showTitles && /*#__PURE__*/React.createElement("h3", {
    className: "cw-section-title"
  }, "Setup instructions"), /*#__PURE__*/React.createElement("div", {
    className: "article-prose"
  }, /*#__PURE__*/React.createElement(Paragraphs, {
    text: r.setup
  }))), hasLimits && /*#__PURE__*/React.createElement("div", {
    className: "cw-section"
  }, showTitles && /*#__PURE__*/React.createElement("h3", {
    className: "cw-section-title"
  }, "Known limitations"), /*#__PURE__*/React.createElement("div", {
    className: "article-prose"
  }, /*#__PURE__*/React.createElement(Paragraphs, {
    text: r.limitations
  })))), /*#__PURE__*/React.createElement(ConnectsWithAuto, {
    auto: r.auto
  }), showContributor !== false && r.ecoKey !== 'homeAssistant' && r.docsLink && /*#__PURE__*/React.createElement("div", {
    className: "cw-doclink-ctas"
  }, /*#__PURE__*/React.createElement("p", {
    className: "cw-doclink-cta"
  }, /*#__PURE__*/React.createElement("a", {
    href: r.docsLink.href,
    target: "_blank",
    rel: "noopener noreferrer"
  }, 'Read the ' + r.docsLink.label, " ", /*#__PURE__*/React.createElement(Icon, {
    name: "open",
    size: 12
  })))));
}
function ConnectsWith({
  ...
  if (tabs.length === 1) {
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
      className: "cw-flat-head"
    }, /*#__PURE__*/React.createElement(window.EcoGlyph, {
      name: tabs[0],
      label: window.connectsWithEcoLabel(tabs[0])
    }), /*#__PURE__*/React.createElement("h2", null, "Connects with ", window.connectsWithEcoLabel(tabs[0]))), /*#__PURE__*/React.createElement("div", {
      className: "connects-with connects-with-flat"
    }, /*#__PURE__*/React.createElement(ConnectsWithPanel, {
      device: device,
      ecoKey: tabs[0],
      showContributor: multiEco
    })));
  }
  const current = tabs.indexOf(active) === -1 ? tabs[0] : active;
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("h2", null, "Connects with"), /*#__PURE__*/React.createElement("div", {
    className: "connects-with"
  }, /*#__PURE__*/React.createElement(CwTabScroller, null, tabs.map(k => /*#__PURE__*/React.createElement("button", {
    key: k,
    type: "button",
    role: "tab",
    ...
    name: k,
    label: window.connectsWithEcoLabel(k)
  }), /*#__PURE__*/React.createElement("span", {
    className: "cw-tab-label"
  }, window.connectsWithEcoLabel(k))))), /*#__PURE__*/React.createElement("div", {
    className: "cw-panel",
    role: "tabpanel"
  }, /*#__PURE__*/React.createElement(ConnectsWithPanel, {
    device: device,
...
function CWLockedField({
  ...
  }, multiline ? /*#__PURE__*/React.createElement("div", {
    className: "ce-pending-text"
  }, /*#__PURE__*/React.createElement(Paragraphs, {
    text: value
  })) : /*#__PURE__*/React.createElement("span", {
    className: empty ? 'ce-pending-empty' : ''
  }, empty ? '-' : value)), window.PendingMeta ? /*#__PURE__*/React.createElement(window.PendingMeta, {
    entry: entry
  }) : null);
}
function ConnectsWithEditor({
  ctx
}) {
  ...
  const pendingTabs = (window.CONNECTS_WITH_ECOSYSTEMS || []).filter(k => draftEco[k] !== true && (pendEcoVal[k] === true || !!cwPendVal[k]));
  const tabDevice = pendingTabs.length ? {
    ...
    specs: {
      ...
      ecosystems: {
        ...draftEco,
        ...Object.fromEntries(pendingTabs.map(k => [k, true]))
      }
    }
  } : draftDevice;
  ...
  const renderEco = (ecoKey, showHead) => {
    ...
    const ev = cwPendVal[ecoKey] || {};
    return /*#__PURE__*/React.createElement("div", {
      className: "cw-edit-eco",
      key: ecoKey
    }, showHead ? /*#__PURE__*/React.createElement("div", {
      className: "ce-subhead cw-edit-eco-head"
    }, r.label) : null, cwLocked(ecoKey, 'setup') ? /*#__PURE__*/React.createElement(CWLockedField, {
      ...
      className: "ce-field",
      htmlFor: 'ce-cw-setup-' + ecoKey
    }, /*#__PURE__*/React.createElement("span", {
      className: "ce-field-label"
    }, "Setup instructions"), /*#__PURE__*/React.createElement("textarea", {
      id: 'ce-cw-setup-' + ecoKey,
      className: "ce-textarea",
      rows: 6,
      placeholder: "Setup steps for this ecosystem. Leave a blank line between paragraphs.",
      value: r.setup || '',
      onChange: e => setEcoField(ecoKey, {
        setup: e.target.value
      })
    })), cwLocked(ecoKey, 'limitations') ? /*#__PURE__*/React.createElement(CWLockedField, {
      label: "Known limitations",
      value: ev.limitations,
      entry: cwPendEntry,
      multiline: true
    }) : /*#__PURE__*/React.createElement("label", {
      className: "ce-field",
      htmlFor: 'ce-cw-limits-' + ecoKey
    }, /*#__PURE__*/React.createElement("span", {
      className: "ce-field-label"
    }, "Known limitations"), /*#__PURE__*/React.createElement("textarea", {
      id: 'ce-cw-limits-' + ecoKey,
      className: "ce-textarea",
      rows: 4,
    ...
    })), isHA ? /*#__PURE__*/React.createElement("div", {
      className: "cw-edit-ha"
    }, /*#__PURE__*/React.createElement(ConnectsWithAuto, {
      auto: r.auto,
      hint: /*#__PURE__*/React.createElement(InfoHint, {
        text: "Collected from Home Assistant. Contributors can't edit this."
      })
    })) : null, isHA ? null : cwLocked(ecoKey, 'docsUrl') ? /*#__PURE__*/React.createElement(CWLockedField, {
      label: "Documentation",
      value: ev.docsUrl,
      entry: cwPendEntry
    }) : /*#__PURE__*/React.createElement("label", {
      className: "ce-field",
      htmlFor: 'ce-cw-docs-' + ecoKey
    }, /*#__PURE__*/React.createElement("span", {
      className: "ce-field-label"
    }, "Documentation"), /*#__PURE__*/React.createElement(CtrlText, {
      id: 'ce-cw-docs-' + ecoKey,
      value: r.docsUrl,
      placeholder: "https://\u2026",
      onChange: v => setEcoField(ecoKey, {
        docsUrl: v
      })
    })));
  };
  ...
  return /*#__PURE__*/React.createElement(FieldShell, {
  ...
  }, single ? 'Setup steps are pre-filled from a protocol template. Edit them or leave the defaults as they are. The set of fields is fixed.' : 'One tab per ecosystem marked compatible in the Ecosystems group below. Setup steps are pre-filled from a protocol template. Edit them or leave the defaults as they are.'), single ? /*#__PURE__*/React.createElement("div", {
    className: "cw-editor"
  }, renderEco(tabs[0], true)) : /*#__PURE__*/React.createElement("div", {
    className: "cw-editor"
  }, /*#__PURE__*/React.createElement(CwTabScroller, null, tabs.map(k => /*#__PURE__*/React.createElement("button", {
    key: k,
    type: "button",
    ...
    className: "cw-tab-label"
  }, window.connectsWithEcoLabel(k), isPendingTab(k) ? /*#__PURE__*/React.createElement("span", {
    className: "cw-tab-dot",
    "aria-hidden": "true"
  }) : null)))), /*#__PURE__*/React.createElement("div", {
    className: "cw-panel"
  }, renderEco(current, false))));
}
