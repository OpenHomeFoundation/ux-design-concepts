/* AUTO-GENERATED build artifact — compiled from drafts.jsx.
   Do not edit this file by hand. Edit drafts.jsx and rebuild. */
...
function allDrafts() {
  ...
  Object.keys(map).forEach(id => {
    if (_ownsEntry(map[id])) out[id] = map[id];
  });
  return out;
}
