/* AUTO-GENERATED build artifact — compiled from notifications.jsx.
   Do not edit this file by hand. Edit notifications.jsx and rebuild. */
...
function loadNotifs() {
  ...
  try {
    ...
    if (raw) {
      _notifs = JSON.parse(raw);
      return _notifs;
    }
  } catch (e) {/* fall through to seed */}
  _notifs = (typeof window !== 'undefined' && window.NOTIF_SEED || []).map(n => ({
    ...n
  }));
  return _notifs;
}
function persistNotifs() {
  try {
    localStorage.setItem(NOTIF_KEY, JSON.stringify(_notifs));
...
function useNotifs() {
  ...
  React.useEffect(() => {
    _notifListeners.add(force);
    return () => {
      _notifListeners.delete(force);
    };
  }, []);
  return loadNotifs();
}
...
const DEFAULT_PREFS = {
  channel: 'email',
  cadence: 'immediate'
}; // channel: 'email'|'github'|'off'; cadence: 'immediate'|'daily'
let _prefs = null;
...
function setPrefs(patch) {
  ...
  try {
    localStorage.setItem(NOTIF_PREF_KEY, JSON.stringify(_prefs));
  } catch (e) {/* private mode */}
...
function useNotifPrefs() {
  const [, force] = React.useReducer(x => x + 1, 0);
  React.useEffect(() => {
    _prefListeners.add(force);
    return () => {
      _prefListeners.delete(force);
    };
  }, []);
  return loadPrefs();
}
...
function notifyDestination(user) {
  ...
  if (override) {
    return {
      address: override,
      verified: !!(user && user.notifyEmailVerified),
      source: 'override'
    };
  }
...
function NotifyDestination({
  ...
  const sendCode = () => {
    ...
    if (acctUsable && v.toLowerCase() === acctEmail.toLowerCase()) {
      setErr('That is already your account email. Leave this blank to use it.');
      return;
    }
    setErr('');
    patchCurrentUser({
  ...
  const confirmCode = () => {
    if (!/^\d{6}$/.test(code.trim())) {
      setCodeErr('Enter the 6-digit code we sent.');
      return;
    }
    setCodeErr('');
    patchCurrentUser({
  ...
  const verifyPanel = verifyFor && /*#__PURE__*/React.createElement("div", {
    className: "ce-verify"
  }, /*#__PURE__*/React.createElement("p", {
    className: "ce-verify-lead"
  }, "Enter the 6-digit code we sent to ", /*#__PURE__*/React.createElement("b", null, verifyFor), " to confirm it."), /*#__PURE__*/React.createElement("div", {
  ...
  }), codeErr && /*#__PURE__*/React.createElement("p", {
    className: "ce-field-error",
    role: "alert"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "alert",
    size: 16
  }), codeErr), /*#__PURE__*/React.createElement("div", {
    className: "ce-sec-form-actions"
  }, /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "btn btn-primary ce-sec-btn",
    onClick: confirmCode
  }, "Verify address"), /*#__PURE__*/React.createElement("button", {
    type: "button",
  ...
  }, "Demo: any 6 digits will do.")));
  const recoveryPrompt = offerRecovery && /*#__PURE__*/React.createElement("div", {
    className: "ce-recovery",
    role: "note"
  }, /*#__PURE__*/React.createElement("span", {
    className: "ce-recovery-ico",
    "aria-hidden": "true"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "shield",
    size: 18
  })), /*#__PURE__*/React.createElement("div", {
    className: "ce-recovery-body"
  }, /*#__PURE__*/React.createElement("b", {
    className: "ce-recovery-title"
  }, "Use this email to recover your account too?"), /*#__PURE__*/React.createElement("p", {
    className: "ce-recovery-text"
  }, "You sign in with a passkey only. Adding a recovery email is your way back in if you ever lose it. Decline and this address just receives notifications."), /*#__PURE__*/React.createElement("div", {
    className: "ce-recovery-actions"
  }, /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "btn btn-primary ce-sec-btn",
    onClick: acceptRecovery
  }, "Use for recovery"), /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "ce-acct-quiet",
  ...
  if (adding) {
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "ce-acct-hint"
    }, "We send a code to confirm the address before any notifications go out."));
  }
  if (hasOverride) {
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    }, dest.address), /*#__PURE__*/React.createElement("span", {
      className: 'ce-pill' + (dest.verified ? ' is-verified' : ' is-pending')
    }, dest.verified ? 'Verified' : 'Unverified')), /*#__PURE__*/React.createElement("div", {
      className: "ce-sec-actions"
    }, !dest.verified && !verifyFor && /*#__PURE__*/React.createElement("button", {
      type: "button",
      className: "ce-acct-quiet ce-acct-quiet-accent",
      onClick: () => {
        setVerifyFor(dest.address);
        setCode('');
        setCodeErr('');
      }
      ...
      type: "button",
      className: "ce-acct-quiet",
      onClick: () => openAdd(dest.address)
    }, "Change"), /*#__PURE__*/React.createElement("button", {
      type: "button",
      className: "ce-acct-quiet ce-acct-quiet-danger",
      onClick: removeOverride
    }, "Remove"))), verifyPanel, recoveryPrompt, acctUsable && !verifyFor && /*#__PURE__*/React.createElement("p", {
      className: "ce-acct-hint"
    }, "Or ", /*#__PURE__*/React.createElement("button", {
      type: "button",
      className: "ce-acct-link-inline",
      onClick: removeOverride
    }, "send to your account email"), " (", acctEmail, ") instead."), !acctUsable && !verifyFor && dest.verified && /*#__PURE__*/React.createElement("p", {
      className: "ce-acct-hint"
    }, "This address only receives notifications. It does not sign you in."));
  }
  if (acctUsable) {
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
      className: "ce-sec-line"
      ...
      className: "ce-sec-status"
    }, acctEmail), /*#__PURE__*/React.createElement("span", {
      className: "ce-dest-note"
    }, "your account email")), /*#__PURE__*/React.createElement("div", {
      className: "ce-sec-actions"
    }, /*#__PURE__*/React.createElement("button", {
      type: "button",
      className: "ce-acct-quiet",
      onClick: () => openAdd('')
    }, "Use a different address"))), /*#__PURE__*/React.createElement("p", {
      className: "ce-acct-hint"
    }, "Managed in Sign-in and security. Add a separate address to receive notifications somewhere else."));
  }

  // No usable address yet — passkey-only, or GitHub with only a noreply email.
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(window.Banner, {
    icon: "info",
    title: "Add an address to get email notifications"
  }, "Until then, updates show on the Your edits page only."), /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "btn btn-secondary ce-sec-btn ce-sec-add ce-notify-add-btn",
    onClick: () => openAdd('')
  }, "Add an address"), user && user.gh && /*#__PURE__*/React.createElement("p", {
    className: "ce-acct-hint"
  }, "Or switch the channel to GitHub above to be notified there."));
}
...
function NotificationsSettings() {
  const user = window.useCurrentUser && window.useCurrentUser() || window.USERS && window.USERS[window.CURRENT_USER] || null;
  ...
  React.useEffect(() => {
    setDraftChannel(prefs.channel || 'email');
  }, [prefs.channel]);
  React.useEffect(() => {
    setDraftCadence(prefs.cadence || 'immediate');
  }, [prefs.cadence]);
  ...
  const connectGithub = () => {
    ...
    if (window.USERS && window.USERS[id]) {
      window.USERS[id] = {
        ...window.USERS[id],
        gh: window.USERS[id].gh || 'yourhandle'
      };
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
  ...
  }, "We let you know when a submitted edit is sent for review, goes live, or is declined. Either way, every update also shows on the Your edits page."), /*#__PURE__*/React.createElement("div", {
    className: "ce-account-form"
  }, /*#__PURE__*/React.createElement("section", {
    className: "ce-account-section"
  }, /*#__PURE__*/React.createElement("h2", {
    className: "ce-account-section-head"
  }, "How we reach you"), /*#__PURE__*/React.createElement("div", {
  ...
  }, c.sub))))))), draftChannel === 'email' && /*#__PURE__*/React.createElement("section", {
    className: "ce-account-section"
  }, /*#__PURE__*/React.createElement("h2", {
    className: "ce-account-section-head"
  ...
  }, "Sent to"), /*#__PURE__*/React.createElement("div", {
    className: "ce-acct-control"
  }, /*#__PURE__*/React.createElement(NotifyDestination, {
    user: user
  }))), /*#__PURE__*/React.createElement("div", {
    className: "ce-acct-row ce-acct-row-firstline"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    id: 'immediate',
    label: 'Immediately',
    sub: 'Email me as each one happens.'
  }, {
    id: 'daily',
    label: 'Daily summary',
    sub: 'One email a day, only if there is something new.'
  }].map(opt => {
  ...
  })))))), draftChannel === 'github' && /*#__PURE__*/React.createElement("section", {
    className: "ce-account-section"
  }, /*#__PURE__*/React.createElement("h2", {
    className: "ce-account-section-head"
  }, "GitHub"), ghConnected ? /*#__PURE__*/React.createElement("p", {
    style: {
      margin: 0,
      fontSize: 'var(--fs-14)',
      color: 'var(--fg-muted)',
  ...
  }, "We will not email you. Choose what GitHub sends you from your watching and notification ", /*#__PURE__*/React.createElement("a", {
    href: "https://github.com/settings/notifications",
    target: "_blank",
    rel: "noopener noreferrer",
    style: { color: 'var(--primary)', textDecoration: 'underline', textUnderlineOffset: '2px' }
  }, "settings"), " on GitHub.") : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("p", {
    style: {
  ...
  }, "Connect your GitHub account to route notifications there. Until then we keep using email."), /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "btn btn-secondary ce-sec-btn ce-sec-add ce-sec-add-gh",
    onClick: connectGithub
  }, /*#__PURE__*/React.createElement(GitHubMark, {
    size: 16
  }), /*#__PURE__*/React.createElement("span", null, "Connect GitHub")))), /*#__PURE__*/React.createElement("div", {
