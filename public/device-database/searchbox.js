/* AUTO-GENERATED build artifact — compiled from searchbox.jsx.
   Do not edit this file by hand. Edit searchbox.jsx and rebuild. */
...
const STOPWORDS = new Set(["the", "and", "for", "with", "via", "not", "but", "only", "can", "may", "over", "this", "that", "into", "when", "also", "does", "has", "have", "its", "they", "them", "from", "than", "then", "use", "used", "uses", "one", "two", "one", "plus", "gen", "pro", "ultra", "mini", "new", "are", "was", "were", "will", "you", "your", "any", "all", "each", "both", "such", "other", "out", "off", "yes", "required", "optional", "still", "every", "most", "more", "less", "between", "across", "without", "under", "like", "just", "very"]);
...
const buildSuggestions = q => {
  ...
  if (term.length >= 2) {
    out.categories = window.DEVICE_CATEGORIES.filter(c => c.label.toLowerCase().includes(term)).slice(0, 5);
  }

  // Devices, after 2 characters. Cap at 5, track total for "see more" row.
  if (term.length >= 2) {
    const allDevices = window.DEVICES.filter(d => (d.name + " " + d.manufacturer + " " + d.model).toLowerCase().includes(term));
  ...
  if (term.length >= 1) {
    out.words = Object.entries(WORD_CORPUS).filter(([w]) => w.startsWith(term) && w !== term).sort((a, b) => b[1] - a[1]).map(([w]) => w).slice(0, 5);
  }
...
const Highlight = ({
  ...
  if (!term) return /*#__PURE__*/React.createElement(React.Fragment, null, text);
  const i = text.toLowerCase().indexOf(term.toLowerCase());
  if (i < 0) return /*#__PURE__*/React.createElement(React.Fragment, null, text);
  return /*#__PURE__*/React.createElement(React.Fragment, null, text.slice(0, i), /*#__PURE__*/React.createElement("mark", null, text.slice(i, i + term.length)), text.slice(i + term.length));
};
const SearchBox = ({
  size = "header",
  autoFocus = false,
  ...
  const matchesFsBreakpoint = () => typeof window !== "undefined" && window.matchMedia("(max-width: 1023px)").matches;
  ...
  React.useEffect(() => {
    ...
    const idx = selectable.findIndex(it => it.kind === "category" && it.value.label.toLowerCase() === t || it.kind === "manufacturer" && String(it.value).toLowerCase() === t);
    setActiveIdx(idx);
  }, [q, selectable]);
  ...
  const dropdownRows = rows.map((row, i) => {
    ...
    if (row.kind === "category") {
      key = "c-" + row.value.id;
      content = /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(CategoryGlyph, {
        category: row.value.id,
        size: 18
      }), /*#__PURE__*/React.createElement("span", {
        className: "searchbox-row-main"
      }, /*#__PURE__*/React.createElement(Highlight, {
        text: row.value.label,
        term: term
      })), /*#__PURE__*/React.createElement("span", {
        className: "searchbox-row-meta"
      }, "Category"));
      ...
      content = /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Icon, {
        ...
        className: "searchbox-row-main searchbox-more-text"
      ...
      key = "q-" + row.value.id;
      content = /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(CategoryGlyph, {
        category: row.value.icon,
        size: 18
      }), /*#__PURE__*/React.createElement("span", {
        className: "searchbox-row-main"
      }, row.value.title), /*#__PURE__*/React.createElement("span", {
        className: "searchbox-row-meta"
      }, row.value.count, " ", row.value.count === 1 ? "device" : "devices"));
  ...
  const renderForm = (refInput, isFs) => /*#__PURE__*/React.createElement("form", {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    ref: wrapRef
  }, renderForm(inputRef, false), showDropdown && !fullscreen && /*#__PURE__*/React.createElement("div", {
  ...
  }, dropdownRows)), fullscreen && /*#__PURE__*/React.createElement("div", {
    className: "searchbox-fs"
  }, /*#__PURE__*/React.createElement("div", {
    className: "searchbox-fs-bg",
    "aria-hidden": "true"
    ...
    name: "arrowL",
    size: 20
  })), renderForm(fsInputRef, true), showDropdown && /*#__PURE__*/React.createElement("div", {
    className: "searchbox-dropdown" + (fsScrolled ? " is-scrolled" : ""),
    role: "listbox",
    ref: fsDropdownRef,
    onScroll: e => {
