...
export const household = {
  ...
  personas: {
    daan: {
      ...
      widgets: ["favorites", "energy", "activity", "todo"],
      presence: "home",
  ...
  services: {
    media: {
      id: "media", name: "Media", icon: "play-circle-outline", route: "/media", space: "shared",
      installed: ["spotify"],
    ...
    calendar: {
      ...
      installed: ["google", "local"],
      calendars: [
        { id: "family", name: "Family", color: "#2e9e5b" },
        { id: "daan", name: "Daan", color: "#1C6FD6" },
        { id: "tess", name: "Tess", color: "#e0a32e" },
        { id: "school", name: "School", color: "#a855f7" },
      ],
      events: [
        { id: "ev1", day: "Today", date: "20 July", time: "08:30", end: "09:00", allDay: false, title: "Bins out", where: "Kerb", who: [], cal: "family", notes: "Green and paper this week." },
        { id: "ev2", day: "Today", date: "20 July", time: "13:00", end: "14:00", allDay: false, title: "Lunch with Marie", where: "Cafe Blij", who: ["Daan"], cal: "daan", notes: "" },
        { id: "ev3", day: "Today", date: "20 July", time: "19:30", end: "21:00", allDay: false, title: "Football training", where: "Sportpark Noord", who: ["Tess"], cal: "tess", notes: "Bring the away kit." },
        { id: "ev4", day: "Tomorrow", date: "21 July", time: "", end: "", allDay: true, title: "Nour visiting", where: "", who: ["Everyone"], cal: "family", notes: "Staying the weekend." },
        { id: "ev5", day: "Tomorrow", date: "21 July", time: "09:00", end: "17:00", allDay: false, title: "Work, on site", where: "Utrecht office", who: ["Daan"], cal: "daan", notes: "" },
        { id: "ev6", day: "Thursday", date: "24 July", time: "15:15", end: "16:00", allDay: false, title: "Parent teacher meeting", where: "De Regenboog", who: ["Daan", "Tess"], cal: "school", notes: "Room 2B, ask about the science project." },
        { id: "ev7", day: "Saturday", date: "26 July", time: "10:00", end: "12:00", allDay: false, title: "Farmers market", where: "Vredenburg", who: ["Everyone"], cal: "family", notes: "" },
      ],
  ...
  serviceIntegrations: {
    ...
    calendar: [
      { id: "google", name: "Google Calendar", desc: "Sync calendars from your Google account", icon: "google", installed: true },
      { id: "local", name: "Local calendar", desc: "Calendars stored on your home, no account needed", icon: "calendar", installed: true },
      { id: "caldav", name: "CalDAV", desc: "Connect any CalDAV server, including iCloud", icon: "calendar-sync", installed: false },
      { id: "office365", name: "Microsoft 365", desc: "Sync calendars from your Microsoft account", icon: "microsoft", installed: false },
    ],
  },
  ...
  // Each item carries a `color` (the icon-tile background). Every tile is a
  // distinct hue so no two rows share a color.
  settingsNav: [
    { items: [
      { id: "ha-cloud", label: "Home Assistant Cloud", icon: "cloud", color: "#2b8fe6", links: [
    ...
    { items: [
      { id: "integrations", label: "Integrations", icon: "power-plug", color: "#4aa64a" },
      { id: "apps", label: "Apps", icon: "view-grid-outline", color: "#e6702b" },
      { id: "voice-assistants", label: "Voice assistants", icon: "assistant", color: "#2f9e8f" },
      { id: "ai-tasks", label: "AI tasks", icon: "robot-happy", color: "#d1568f" },
    ]},
    { items: [
      { id: "dashboards", label: "Dashboards", icon: "view-dashboard-outline", color: "#3a86c8" },
      { id: "dev-entities", label: "Entities", icon: "format-list-bulleted", color: "#b84fd0" },
      { id: "helpers", label: "Helpers", icon: "tune-variant", color: "#7a8f2e" },
      { id: "blueprints", label: "Blueprints", icon: "puzzle-outline", color: "#8a5cf6" },
    ]},
    { items: [
      { id: "matter", label: "Matter", icon: "lan", color: "#7e57c2" },
      { id: "zigbee", label: "Zigbee", icon: "z-wave", color: "#00897b" },
      { id: "zwave", label: "Z-Wave", icon: "z-wave", color: "#c2185b" },
      { id: "bluetooth", label: "Bluetooth", icon: "bluetooth", color: "#1c6fd6" },
      { id: "knx", label: "KNX", icon: "cable-data", color: "#0aa06e" },
    ]},
    { items: [
      { id: "general", label: "Home information", icon: "home", color: "#2fa562" },
      { id: "credentials", label: "People", icon: "account-multiple", color: "#e0574f", links: [
        { label: "Users", icon: "account-multiple-outline" },
        { label: "Long-lived access tokens", icon: "key-variant" },
      ]},
    ]},
    { items: [
      { id: "floors-areas", label: "Floors and areas", icon: "layers-outline", color: "#6d6d75" },
      { id: "labels", label: "Labels", icon: "label", color: "#e0a32e" },
      { id: "zones", label: "Zones", icon: "map-marker-radius", color: "#2aa6b3" },
    ]},
    { items: [
      { id: "updates", label: "Updates", icon: "update", color: "#17a0b0" },
      { id: "repairs", label: "Repairs", icon: "wrench", color: "#e07a2e" },
      { id: "logs", label: "Logs", icon: "text-box-outline", color: "#5b8def" },
    ]},
    { items: [
      { id: "storage", label: "Storage", icon: "harddisk", color: "#6faa2e" },
      { id: "backups", label: "Backups", icon: "backup-restore", color: "#12a594" },
      { id: "network", label: "Network", icon: "wifi", color: "#e06a3a" },
      { id: "hardware", label: "Hardware", icon: "chip", color: "#c247a0" },
    ]},
    { items: [
      { id: "analytics", label: "Analytics", icon: "chart-box", color: "#5568c8" },
      { id: "labs", label: "Labs", icon: "flask", color: "#8a54ec" },
    ]},
    { items: [
      { id: "about", label: "About", icon: "information-outline", color: "#6d6d75" },
    ]},
  ],

  // Developer tools (its own top-level menu item, below Settings)
  developerToolsNav: [
    { items: [
      { id: "yaml", label: "YAML", icon: "code-braces", color: "#6a5cf0" },
      { id: "dev-states", label: "States", icon: "table", color: "#9c6ade" },
      { id: "dev-actions", label: "Actions", icon: "flash", color: "#c9b52f" },
      { id: "dev-template", label: "Template", icon: "code-json", color: "#1ba57e" },
      { id: "dev-events", label: "Events", icon: "lightning-bolt-outline", color: "#d64f6e" },
      { id: "statistics", label: "Statistics", icon: "chart-line", color: "#3a7fe0" },
    ]},
  ],
  ...
  personalSettingsNav: [
    ...
    { title: "Personal", items: [
      ...
      { id: "p-locale", label: "Language and region", icon: "translate" },
    ]},
    { title: "This device", items: [
      { id: "p-device", label: "App settings", icon: "cellphone-cog" },
    ]},
  ],
...
export const directory = [
  ...
  { id: "home", label: "Overview", icon: "home", space: "shared", route: "/home" },
  // Shared, discovery
  ...
  { id: "media", label: "Media", icon: "play-circle-outline", space: "shared", route: "/media" },
  ...
  { id: "developer-tools", label: "Developer tools", icon: "hammer-wrench", space: "admin", route: "/developer-tools" },
...
// are not themselves More destinations live here; bookmark resolution checks
// the directory first, then these extras.
...
if (typeof window !== "undefined") {
  window.__HH_MOD = {
    ...
    getPersona, entitiesIn, areaList, visibleFloors, canAccessArea, bookmarkResolve, energyFor,
    normalizeStructure, floorsOfBuilding, groundFloorOf,
